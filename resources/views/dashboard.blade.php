...
<body>
    <div class="Dasboard" style="width: 1363px; height: 919px; position: relative; background: white">
    ...
    <div class="Group34" style="width: 350px; height: 334px; left: 310px; top: 119px; position: absolute">
        <div class="Rectangle17"
            style="width: 350px; height: 334px; left: 0px; top: 0px; position: absolute; background: #62D2A2; border-radius: 20px; border: 3px #1FAB89 solid">
        </div>
        <div class="PesananMasuk"
            ...
            PESANAN MASUK</div>
        <div
            style="left: 151px; top: 109px; position: absolute; text-align: center; color: white; font-size: 96px; font-family: Inter; font-weight: 500; word-wrap: break-word">
            1</div>
    </div>
    <div class="Group35" style="width: 350px; height: 334px; left: 909px; top: 117px; position: absolute">
        <div class="Rectangle17"
            style="width: 350px; height: 334px; left: 0px; top: 0px; position: absolute; background: #62D2A2; border-radius: 20px; border: 3px #1FAB89 solid">
        </div>
        <div class="JumlahObat"
            style="width: 290px; height: 43.13px; left: 37.78px; top: 24.33px; position: absolute; text-align: center; color: #FCFCFC; font-size: 32px; font-family: Inter; font-weight: 600; word-wrap: break-word">
            JUMLAH OBAT</div>
        <div
            style="left: 83px; top: 109px; position: absolute; text-align: center; color: white; font-size: 96px; font-family: Inter; font-weight: 500; word-wrap: break-word">
            200</div>
    </div>
    </div>
</body>
